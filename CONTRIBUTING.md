...
Busy Octopus is a local-only notification bridge. Preserve its generic core, workspace-scoped queue, VS Code UI-host routing, Workspace Trust requirement, fail-open integrations, privacy boundaries, and independent delivery adapters.
